...
export async function checkAutomationAccess(
  ...
  // 0. OWNER_TEST_ACCESS Capability Check
  // Grants universal access to existing automation products for the designated test account
  if (await isOwnerTestAccount(clerkUserId)) {
