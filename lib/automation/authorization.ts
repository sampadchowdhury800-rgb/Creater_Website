...
import { resolveAutomationWorkflowId } from "./workflow-resolver";
...
export async function authorizeAutomationExecution(
  ...
  const resolvedWorkflowId = resolveAutomationWorkflowId(automation);
  ...
  return {
    authorized: true,
    userAutomation,
    n8nWorkflowId: resolvedWorkflowId,
    statusCode: 200,
  };
}
