          ...
          <div className="flex flex-col lg:flex-row gap-12">
            ...
            <div className="lg:w-2/5 flex flex-col">
              ...
              <div className="flex flex-col gap-3 mb-8">
                {isFreeProduct || hasActiveAccess ? (
                  <button
                    onClick={() => {
                      if (existingUserAutomationId) {
                        router.push(`/my-automations/${existingUserAutomationId}`);
                      } else {
                        handleAddToMyAutomations();
                      }
                    }}
                    disabled={isAddingToMyAutomations}
                    className="w-full py-4 bg-primary text-black hover:bg-primary-fixed font-extrabold rounded-xl transition-all active:scale-95 flex items-center justify-center gap-2 shadow-[0_0_25px_rgba(0,219,238,0.3)] cursor-pointer disabled:opacity-70"
                  >
