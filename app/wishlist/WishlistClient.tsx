          ...
          {isLoading ? (
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              {wishlistItems.map((item) => (
                <div key={item.automation.id} className="group flex flex-col bg-white/80 dark:bg-white/5 border border-black/10 dark:border-white/10 rounded-2xl overflow-hidden hover:bg-white dark:hover:bg-white/10 shadow-sm dark:shadow-none transition-all duration-300">
                  <Link href={`/automations/${item.automation.slug}`} className="relative aspect-video w-full bg-black/10 dark:bg-black/40">
                  ...
                  <div className="flex flex-col p-5 flex-1">
                    <Link href={`/automations/${item.automation.slug}`} className="font-bold text-lg text-slate-900 dark:text-white hover:text-primary-fixed-dim transition-colors mb-4">
