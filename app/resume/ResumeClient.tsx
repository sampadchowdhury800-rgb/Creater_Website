...
export default function ResumeClient({
  ...
  return (
    <ThemeProvider>
      <div className="bg-background text-on-surface min-h-screen selection:bg-cyan-400 selection:text-black">
        ...
        <div className="pt-28 pb-4 px-6 md:px-12 max-w-[1100px] mx-auto flex justify-between items-center print:hidden">
          <nav className="flex items-center gap-2 text-xs font-mono text-slate-500 dark:text-gray-400">
            <Link href="/" className="hover:text-cyan-600 dark:hover:text-cyan-400 transition-colors">
              Home
            </Link>
            <span>/</span>
            <span className="text-cyan-700 dark:text-cyan-400">Resume</span>
          </nav>
          <button
            onClick={() => window.print()}
            className="px-4 py-2 rounded-xl bg-cyan-100 dark:bg-cyan-950/60 border border-cyan-400/40 dark:border-cyan-500/30 text-cyan-800 dark:text-cyan-400 text-xs font-mono flex items-center gap-2 hover:bg-cyan-200 dark:hover:bg-cyan-900/60 transition-colors cursor-pointer"
          >
        ...
        <main className="py-8 px-6 md:px-12 max-w-[1100px] mx-auto print:p-0 print:m-0 print:max-w-full">
          <div className="bg-white/90 dark:bg-[#111622]/90 border border-black/10 dark:border-white/10 rounded-3xl p-8 md:p-14 backdrop-blur-xl space-y-12 shadow-sm dark:shadow-[0_0_50px_rgba(0,0,0,0.5)] print:bg-white print:text-black print:border-none print:shadow-none print:p-0">
            {/* Header / Identity */}
            <header className="border-b border-black/10 dark:border-white/10 pb-8 print:border-black/20">
              <div className="flex flex-col md:flex-row md:items-center justify-between gap-6">
                <div>
                  <h1 className="text-3xl md:text-5xl font-black tracking-tight text-slate-900 dark:text-white print:text-black">
                    {name}
                  </h1>
                  <p className="text-cyan-700 dark:text-cyan-400 print:text-blue-700 font-mono text-sm md:text-base font-semibold mt-1">
                    {title}
                  </p>
                  <p className="text-slate-600 dark:text-gray-400 print:text-gray-600 text-xs md:text-sm mt-1">
                ...
                <div className="flex flex-wrap gap-2 print:text-black">
                  <a
                    href={`mailto:${email}`}
                    className="px-3 py-1.5 rounded-lg bg-black/5 dark:bg-white/5 border border-black/10 dark:border-white/10 text-xs text-slate-700 dark:text-gray-200 hover:text-cyan-700 dark:hover:text-cyan-300 transition-colors flex items-center gap-1.5 print:border-gray-300 print:text-black"
                  >
                  ...
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="px-3 py-1.5 rounded-lg bg-black/5 dark:bg-white/5 border border-black/10 dark:border-white/10 text-xs text-slate-700 dark:text-gray-200 hover:text-black dark:hover:text-white transition-colors flex items-center gap-1.5 print:border-gray-300 print:text-black"
                  >
            ...
            <section className="space-y-4">
              <h2 className="text-xs font-mono uppercase tracking-widest text-cyan-700 dark:text-cyan-400 print:text-blue-800 font-bold">
                01 // Professional Summary
              </h2>
              <p className="text-slate-700 dark:text-gray-300 print:text-gray-800 text-sm md:text-base leading-relaxed">
                {person?.bio ||
            ...
            <section className="space-y-4">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div className="p-4 rounded-xl bg-slate-50 dark:bg-white/5 border border-slate-200 dark:border-white/5 print:border-gray-200 print:bg-gray-50">
                  <h3 className="text-xs font-mono text-slate-500 dark:text-gray-400 print:text-gray-600 uppercase mb-2">
                    Full-Stack &amp; Frameworks
                  </h3>
                  <p className="text-xs md:text-sm text-slate-800 dark:text-gray-200 print:text-black leading-relaxed">
                    ...
                    >
                      <div className="flex flex-col md:flex-row md:items-center justify-between">
                        <h3 className="text-base font-bold text-slate-900 dark:text-white print:text-black">
                          {exp.role} <span className="text-cyan-700 dark:text-cyan-400 print:text-blue-800 font-normal">@ {exp.company}</span>
                        </h3>
                        <span className="text-xs font-mono text-slate-500 dark:text-gray-400 print:text-gray-600">
                          {exp.period}
                        </span>
                      </div>
                      <p className="text-xs md:text-sm text-slate-600 dark:text-gray-300 print:text-gray-700 leading-relaxed">
                        {exp.description}
                      </p>
                      {Array.isArray(exp.highlights) && (
                        <ul className="list-disc list-inside text-xs text-slate-500 dark:text-gray-400 print:text-gray-600 space-y-1">
