          ...
          {orders.length === 0 ? (
            ...
            <div className="flex flex-col gap-6">
              {orders.map((order) => {
                ...
                return (
                  <div key={order.id} className="bg-white/80 dark:bg-white/5 border border-black/10 dark:border-white/10 rounded-2xl overflow-hidden shadow-sm dark:shadow-none">
                    <div className="bg-black/5 dark:bg-white/5 px-6 py-4 border-b border-black/10 dark:border-white/10 flex flex-col md:flex-row md:items-center justify-between gap-4">
                      <div className="flex flex-wrap gap-x-8 gap-y-2 text-sm">
                        ...
                        <div>
                          ...
                          <p className="font-bold text-cyan-700 dark:text-primary">₹{(order.totalAmount / 100).toLocaleString()}</p>
                        </div>
                        <div>
