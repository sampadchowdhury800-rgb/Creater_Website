      ...
      <div className="bg-background text-on-surface min-h-screen selection:bg-cyan-400 selection:text-black">
        ...
        <section className="relative pt-36 pb-20 px-6 md:px-12 max-w-[1300px] mx-auto overflow-hidden">
          ...
          <div className="relative z-10 text-center max-w-3xl mx-auto space-y-6">
            <span className="inline-block px-4 py-1.5 rounded-full border border-cyan-400/40 bg-cyan-100 dark:bg-cyan-950/40 text-cyan-700 dark:text-cyan-300 text-xs font-mono tracking-widest uppercase">
              ABOUT CHOWDHURY DUO
            </span>
