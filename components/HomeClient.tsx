      ...
      <div className="bg-background selection:bg-primary-container selection:text-on-primary-container">
        ...
        <section className="hero-section">
          ...
          <div className="relative z-10 text-center px-gutter max-w-5xl mx-auto">
            ...
            <p className="text-slate-600 dark:text-gray-300 max-w-2xl mx-auto mt-6 text-sm md:text-base leading-relaxed">
        ...
        {services.length > 0 && (
          <section className="py-16 px-4 md:px-8 max-w-[1400px] mx-auto">
            <div className="flex flex-col md:flex-row md:items-end justify-between mb-10 gap-4">
              <div>
                <span className="text-cyan-600 dark:text-cyan-400 font-mono text-xs uppercase tracking-widest">
                  CORE EXPERTISE
                </span>
              ...
              <Link
                href="/services"
                className="text-cyan-600 hover:text-cyan-500 dark:text-cyan-400 dark:hover:text-cyan-300 font-mono text-xs font-semibold flex items-center gap-1"
              >
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              {services.map((s) => (
                <Link
                  ...
                  className="group p-6 rounded-2xl bg-white/80 dark:bg-[#111622]/60 border border-black/10 dark:border-white/10 hover:border-cyan-500/40 hover:bg-white dark:hover:bg-[#111622] transition-all flex flex-col justify-between shadow-sm dark:shadow-none"
                >
                  <div>
                    <div className="w-12 h-12 rounded-xl bg-cyan-100/80 dark:bg-cyan-950/60 border border-cyan-400/40 dark:border-cyan-500/30 flex items-center justify-center text-cyan-600 dark:text-cyan-400 mb-4 group-hover:scale-110 transition-transform">
                    ...
                    <p className="text-slate-600 dark:text-gray-400 text-xs md:text-sm mt-2 line-clamp-3 leading-relaxed">
                      {s.shortDesc}
                    </p>
                  </div>
                  <div className="mt-6 flex items-center text-cyan-600 dark:text-cyan-400 text-xs font-mono font-medium">
                ...
                >
                  ...
                  <div className="mt-6 flex flex-wrap gap-1">
                    {p.technologies.slice(0, 3).map((t) => (
                      <span
                        key={t}
                        className="px-2 py-0.5 bg-black/5 dark:bg-white/5 rounded text-[10px] font-mono text-slate-700 dark:text-gray-300"
                      >
                        {t}
                      </span>
                    ))}
